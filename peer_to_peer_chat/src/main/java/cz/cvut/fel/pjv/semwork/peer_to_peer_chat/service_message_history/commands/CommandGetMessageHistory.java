...
import cz.cvut.fel.pjv.semwork.peer_to_peer_chat.models.enums.message_history_type.MessageHistoryType;
...
import cz.cvut.fel.pjv.semwork.peer_to_peer_chat.models.events.GetMessageHistoryEvent;
...
public class CommandGetMessageHistory implements ICommand {
    ...
    public void execute(Event<?, ?> input) {
        ...
        if (!(input instanceof GetMessageHistoryEvent temp)) {
            return;
        }
